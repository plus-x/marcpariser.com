...
$atts = array(
    ...
    'options' => array(
        array(
            ...
            'value' => '_self',
            'options' => array(
                'col-sm-12' => __('One column','tfuse'),
                'col-sm-6' => __('One half column (1/2)','tfuse'),
                'col-sm-4' => __('One third column (1/3)','tfuse'),
                'col-sm-3' => __('A fourth column (1/4)','tfuse'),
                'col-sm-8' => __('Two thirds column (2/3)','tfuse'),
                'col-sm-9' => __('Three fourths column (3/4)','tfuse'),
            ),
            'type' => 'select'
        ),
        array(
            'name' => __('Class','tfuse'),
            'desc' => __('Specifies one or more class names for an shortcode:box_green,box_yellow,box_pink,box_blue...','tfuse'),
            'id' => 'tf_shc_col_class',
            'value' => '',
            'type' => 'text'
        ),
