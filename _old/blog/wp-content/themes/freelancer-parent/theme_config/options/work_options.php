...
$options = array(
    ...
    array('name' => __('Enable Image','tfuse'),
        ...
        'value' => tfuse_options('enable_work_image',true),
        'type' => 'checkbox'
    ),
    ...
    array('name' => __('Enable Video','tfuse'),
        ...
        'value' => tfuse_options('enable_work_video',true),
        'type' => 'checkbox'
    ),
    ...
    // Select work type
    array(
        'name' => __('Select work type','tfuse'),
        'desc' => __('Select work type.','tfuse'),
        'id' => TF_THEME_PREFIX . '_work_type',
        'value' => 'image',
    ...
    array('name' => __('Display type','tfuse'),
        ...
        'id' => TF_THEME_PREFIX . '_content_position',
        'value' => tfuse_options('work_content_position'),
        'options' => array(
            'img1' => array(get_template_directory_uri().'/images/'. 'work1.png', __('Big text(2/3) and small image(1/3)', 'tfuse')),
            'img2' => array(get_template_directory_uri().'/images/'. 'work2.png', __('1/2 text and 1/2 image', 'tfuse')),
            'img3' => array(get_template_directory_uri().'/images/'. 'work3.png', __('2/3 text and 2/3 transparent image', 'tfuse')),
        ),
        'type' => 'images',
        'divider' => true
    ),
    ...
    array('name' => __('Image Resize (px)','tfuse'),
        ...
        'value' => tfuse_options('work_image_dimensions'),
        'type' => 'textarray',
    ),
    ...
    array('name' => __('Image Position','tfuse'),
        ...
        'value' => tfuse_options('work_image_position'),
        'options' => array(
    ...
    array('name' => __('Video Size (px)','tfuse'),
        ...
        'value' => tfuse_options('work_video_dimensions'),
        'type' => 'textarray'
    ),
    // Video Position
    array('name' => __('Video Position','tfuse'),
        ...
        'value' => tfuse_options('work_video_position'),
        'options' => array(
            'pull-left' => array($url . 'left_off.png', __('Align to the left', 'tfuse')),
            'pull-right' => array($url . 'right_off.png', __('Align to the right', 'tfuse'))
        ),
    ...
    // Specify animate type
    array(
        'name' => __('Specify animate type','tfuse'),
        'desc' => __('Specify animate type. Ex: bounceInDown, bounceInRight, bounceInLeft, flipInY, fadeIn. ( <a target="_blank" href="https://daneden.me/animate">Full animation list</a> )','tfuse'),
        'id' => TF_THEME_PREFIX . '_animate_type',
        'value' => 'bounceInDown',
        'type' => 'text',
    ),
    array(
        'name' => __('Show line ?','tfuse'),
        'desc' => __('Show line between image and content ?','tfuse'),
        'id' => TF_THEME_PREFIX . '_show_line',
        'value' => false,
        'type' => 'checkbox',
    ),
    /* Elements */
    array('name' => __('Elements','tfuse'),
        'id' => TF_THEME_PREFIX . '_elements',
        'type' => 'metabox',
        'context' => 'normal'
    ),
    // Live preview
    array(
        'name' => __('Live preview','tfuse'),
        'desc' => __('Live preview button text.','tfuse'),
        'id' => TF_THEME_PREFIX . '_live_button',
        'value' => 'Live preview',
        'type' => 'text',
    ),
    array(
        'name' => __('Live preview URL','tfuse'),
        'desc' => __('Live preview URL.','tfuse'),
        'id' => TF_THEME_PREFIX . '_live_url',
        'value' => '#',
        'type' => 'text',
    ),
