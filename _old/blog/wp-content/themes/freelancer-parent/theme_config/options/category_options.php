...
$options = array(
    // Mini icon
    array('name' => __('Mini icon','tfuse'),
        'desc' => __('Here you can upload the mini icon for category. Recomended dimensions 20x20','tfuse'),
        'id' => TF_THEME_PREFIX . '_mini_icon',
        'value' => '',
        'type' => 'upload'
    ),
    // Title
    ...
    array('name' => __('Custom Title','tfuse'),
        'desc' => __('Enter your custom title for this category. You can use tag h1,h2 and class. Ex: h2 class="title"','tfuse'),
    ...
    array('name' => __('Category icon','tfuse'),
        'desc' => __('Here you can upload the icon for category.','tfuse'),
