...
$options = array(
    ...
    array('name' => __('Enable Image','tfuse'),
        ...
        'value' => tfuse_options('enable_service_image',true),
        'type' => 'checkbox'
    ),
    ...
    array('name' => __('Enable Video','tfuse'),
        ...
        'value' => tfuse_options('enable_service_video',true),
        'type' => 'checkbox'
    ),
    // Enable Image Lines
    array('name' => __('Enable Image Lines','tfuse'),
        'desc' => '',
        'id' => TF_THEME_PREFIX . '_enable_img_lines',
        'value' => tfuse_options('enable_service_img_lines',true),
        'type' => 'checkbox'
    ),
    ...
    // Left Content Box
    array('name' => __('Left Content Box','tfuse'),
        'desc' => __('Write here the content for left box.','tfuse'),
        'id' => TF_THEME_PREFIX . '_content_left',
        'value' => '',
        'type' => 'textarea'
    ),
    // Right Content Box
    array('name' => __('Right Content Box','tfuse'),
        'desc' => __('Write here the content for right box.','tfuse'),
        'id' => TF_THEME_PREFIX . '_content_right',
        'value' => '',
        'type' => 'textarea',
        'divider' => true
    ),
    // Select service type
    array(
        'name' => __('Select service type','tfuse'),
        'desc' => __('Select service type.','tfuse'),
        'id' => TF_THEME_PREFIX . '_service_type',
        'value' => 'image',
    ...
    array('name' => __('Image Resize (px)','tfuse'),
        ...
        'value' => tfuse_options('service_image_dimensions'),
        'type' => 'textarray',
    ),
    ...
    array('name' => __('Image Position','tfuse'),
        ...
        'value' => tfuse_options('service_image_position'),
        'options' => array(
    ...
    array('name' => __('Video Size (px)','tfuse'),
        ...
        'value' => tfuse_options('service_video_dimensions'),
        'type' => 'textarray'
    ),
    // Video Position
    array('name' => __('Video Position','tfuse'),
        ...
        'value' => tfuse_options('service_video_position'),
        'options' => array(
            'noalign' => array($url . 'full_width.png', __('Don\'t apply an alignment', 'tfuse')),
            'pull-left' => array($url . 'left_off.png', __('Align to the left', 'tfuse')),
            'pull-right' => array($url . 'right_off.png', __('Align to the right', 'tfuse'))
    ...
    array('name' => __('Button title','tfuse'),
        'desc' => __('Write here the title for button.','tfuse'),
        'id' => TF_THEME_PREFIX . '_button_title',
        'value' => "I'm available for hire",
        'type' => 'text'
    ),
    // Button link
    array('name' => __('Button URL','tfuse'),
        'desc' => __('Write here the URL for button.','tfuse'),
        'id' => TF_THEME_PREFIX . '_button_url',
        'value' => "#",
        'type' => 'text'
    ),
