...
if ( ! function_exists( 'tfuse_add_css' ) ) :
    ...
    {
		wp_register_style( 'fonts', 'http://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic,700italic');
		wp_enqueue_style( 'fonts' );
		
        wp_register_style( 'bootstrap', tfuse_get_file_uri('/css/bootstrap.min.css'));
        ...
        wp_register_style( 'style_css', tfuse_get_file_uri('/style.css'));
...
if ( ! function_exists( 'tfuse_add_js' ) ) :
    ...
    function tfuse_add_js()
    {
        ...
        wp_register_script( 'bootstrap', tfuse_get_file_uri('/js/bootstrap.js'), array('jquery'), '', true );
        wp_enqueue_script( 'bootstrap' );

        wp_register_script( 'cusel', tfuse_get_file_uri('/js/cusel.min.js'), array('jquery'), '', true );
        wp_enqueue_script( 'cusel');

        wp_register_script( 'jScrollPane', tfuse_get_file_uri('/js/jScrollPane.js'), array('jquery'), '', true );
        wp_enqueue_script( 'jScrollPane' );
		
		wp_register_script( 'mousewheel', tfuse_get_file_uri('/js/jquery.mousewheel.js'), array('jquery'), '', true );
        wp_enqueue_script( 'mousewheel' );

        wp_register_script( 'carouFredSel', tfuse_get_file_uri('/js/jquery.carouFredSel.min.js'), array('jquery'), '', true );
        wp_enqueue_script( 'carouFredSel' );

        wp_register_script( 'scrollTo', tfuse_get_file_uri('/js/jquery.scrollTo.min.js'), array('jquery'), '', true );
        ...
        $theme_array = array('template_directory' => $template_directory);
        wp_localize_script( 'general', 'tfuse_template_dir', $theme_array );
        ...
        wp_register_script( 'jquery.mobile', tfuse_get_file_uri('/js/libs/jquery.mobile.custom.min.js'), array('jquery'), '', true );
