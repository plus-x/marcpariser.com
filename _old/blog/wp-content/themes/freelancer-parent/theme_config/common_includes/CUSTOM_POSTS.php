 ...
 */
    function tfuse_create_custom_post_types()
    {
        ...
        $labels = array(
            'name' => __('Work', 'tfuse'),
            'singular_name' => __('Work', 'tfuse'),
            'add_new' => __('Add New', 'tfuse'),
            'add_new_item' => __('Add New Work', 'tfuse'),
        ...
        $args = array(
            ...
            'query_var' => true,
            'has_archive' => true,
            'rewrite' => array('slug'=> $worklist_rewrite),
            'menu_position' => 5,
            'show_in_nav_menus' => false,
        ...
        $worklist_taxonomy_rewrite = apply_filters('tfuse_worklist_taxonomy_rewrite','works');
        register_taxonomy('works', array('work'), array(
            'hierarchical' => true,
            'labels' => $labels,
            'show_ui' => true,
            'query_var' => true,
