...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		<h3 class="comments-title">
			<?php
				printf( _nx( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'zircone' ),
		...
		<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
			<h2 class="screen-reader-text"><?php _e( 'Comment navigation', 'zircone' ); ?></h2>
			<div class="nav-links">

				<div class="nav-previous"><?php previous_comments_link( __( 'Older Comments', 'zircone' ) ); ?></div>
				<div class="nav-next"><?php next_comments_link( __( 'Newer Comments', 'zircone' ) ); ?></div>
	...
	?>
		<p class="no-comments"><?php _e( 'Comments are closed.', 'zircone' ); ?></p>
	<?php endif; ?>
