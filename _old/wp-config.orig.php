...
define('DB_NAME', 'wrogowiewo61_lunapark');

/** MySQL database username */
define('DB_USER', 'wrogowiewo61_ww');

/** MySQL database password */
define('DB_PASSWORD', 'jp2gmd!');

/** MySQL hostname */
define('DB_HOST', 'mysql.wrogowiewo61.website.pl');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         ':dwGKL m5@@s6jnaz-q>P=-h. D/ (&]I`=BvW&2NpwKpd7.^pyLC.:[)2J_gnba');
define('SECURE_AUTH_KEY',  'qO,IW[Ja?i=)1ltD+Ct~_@h9gQ1&uDPMSt}%<~r+8OP?Aq6,/X!+Lu0|:G#^NAn+');
define('LOGGED_IN_KEY',    '||Arff:=#5+oP!s/Io0b*5&w[Mufs XY!xR>=T19r=@wsL# ab#o|cG0|I J?Q6S');
define('NONCE_KEY',        'Vck%orPl l=W00),>F&$yc_-5Y1WW:O#|T>])(Oz<@*a;4|zrdq-fE}X+|H)d@9*');
define('AUTH_SALT',        ']t$E_7: x3xd6V_=+rw:EBI@(+R/fF3gk bg#M#uM(_J-AQ%6B|>Etke7DGY6gGx');
define('SECURE_AUTH_SALT', '&;^N?$D[$|-f^r%HAIgQJn$[T254K^L<AJ:Q2<vH21+j-~..(@l:Qe6DmM>N-E/U');
define('LOGGED_IN_SALT',   '}Z+6,=:x>|L:[G%dB}Xx^$whmPP[<u;+vG53tDdY}8:5cFdV<`;M!Va+}&/aE=+0');
define('NONCE_SALT',       'T7RdxIF6F+N%5AZJ7K^hW#E]`C(nY=myAn)!(s8EW#=(VG)Me{KmExvwBv%H]s5<');
