            ...
            default :
                ...
                <li <?php comment_class('comment'); ?> id="li-comment-<?php comment_ID(); ?>">
                    ...
                    <div id="li-comment-<?php comment_ID() ?>" class="comment_body">
                        ...
                        <div class="comment_avatar"><?php echo get_avatar( $comment, 81 ); ?></div>
                        <?php $defaults = array('add_below' => 'comment', 'respond_id' => 'respond'.$post_id, 'reply_text' => __('reply','tfuse'),
                        'login_text' => __('Log in to Reply','tfuse'), 'before' => '', 'after' => '');
                        $args = wp_parse_args($args, $defaults);
                        ?>
                        <div class="comment_text">
                            <a href="#" class="link-author"><?php comment_author_link() ?></a>
                            <span class="comment-date"><?php comment_date('j M Y'); ?></span> | <?php echo get_comment_reply_link( array_merge( $args, array(  'depth' => $depth, 'max_depth' => $args['max_depth'] ) ),get_comment_ID(),$post_id ); ?>
