...
<div id="<?php echo $title; ?>" <?php tfuse_page_bk_style($page_id); ?> class="section">
    ...
    <div class="inner">
        ...
        <div class="section-ico">
            <span class="color-bg" style="background:<?php echo tfuse_page_options('icon_bg','',$page_id); ?>;"></span>
            <img src="<?php echo tfuse_page_options('page_icon','',$page_id); ?>" alt=""/>
            <h5 class="mini-title" style="color:<?php echo tfuse_page_options('icon_color','',$page_id); ?>"><?php echo tfuse_page_options('icon_title','',$page_id); ?></h5>
        </div>
        <?php } ?>
        <div class="container">
            <?php
