...
function tfuse_frame($atts, $content = null)
{
    ...
    if ($prettyphoto == 'true')
        return '<a href="' . $src . '" target="' . $target . '" data-rel="prettyPhoto" ><img class="image_frame pull-' . $align . ' preload" src="' . $src . '"  width="' . $width . '" height="' . $height . '" alt="' . $alt . '" /></a>';
    else
        return '<a href="' . $link . '" target="' . $target . '"><img class="image_frame pull-' . $align . '" src="' . $src . '"  width="' . $width . '" height="' . $height . '" alt="' . $alt . '"  /></a>';
}
