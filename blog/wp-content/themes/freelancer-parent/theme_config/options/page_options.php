...
$options = array(
    ...
    array('name' => __('Custom Title','tfuse'),
        'desc' => __('Enter your custom title for this page. You can use tag h1,h2 and class. Ex: h2 class="title"','tfuse'),
    ...
    array('name' => __('Custom Subtitle','tfuse'),
        'desc' => __('Enter your custom subtitle for this page. You can use tag h1,h2 and class. Ex:h5 class="top-title"','tfuse'),
        'id' => TF_THEME_PREFIX . '_custom_subtitle',
        'value' => '',
        'type' => 'text'
    ),
    // Social
    array('name' => __('Show Social ?','tfuse'),
        'desc' => __('Show the social buttons in page ?','tfuse'),
        'id' => TF_THEME_PREFIX . '_page_social',
        'value' => true,
        'type' => 'checkbox'
    ),
    // Show Image Line
    array('name' => __('Show Image Line ?','tfuse'),
        'desc' => __('Show oblique line for image ?','tfuse'),
        'id' => TF_THEME_PREFIX . '_image_line',
        'value' => true,
        'type' => 'checkbox'
    ),
    /* ----------------------------------------------------------------------------------- */
    ...
    // Page icon
    array('name' => __('Page icon','tfuse'),
        'desc' => __('Here you can upload the icon for page.','tfuse'),
        'id' => TF_THEME_PREFIX . '_page_icon',
        'value' => '',
        'type' => 'upload'
    ),
    // Icon Title
    array('name' => __('Icon Title','tfuse'),
        'desc' => __('Here you can write the icon title.','tfuse'),
        'id' => TF_THEME_PREFIX . '_icon_title',
        'value' => '',
        'type' => 'text',
        'divider' => true
    ),
    ...
    array('name' => __('Image','tfuse'),
        'desc' => __('Here you can upload your image.','tfuse'),
        'id' => TF_THEME_PREFIX . '_about_image',
        'value' => '',
        'type' => 'upload'
    ),
    // Image Alignment
    array('name' => __('Image Alignment','tfuse'),
        'desc' => __('Select the image alignment.','tfuse'),
        'id' => TF_THEME_PREFIX . '_image_alignment',
        'value' => 'pull-left',
        'options' => array('pull-left' => __('Left','tfuse'), 'pull-right' => __('Right','tfuse')),
        'type' => 'select'
    ),
    // Resume
    array('name' => __('Upload Resume','tfuse'),
        'desc' => __('Here you can upload your resume.','tfuse'),
        'id' => TF_THEME_PREFIX . '_resume',
        'value' => '',
        'type' => 'upload',
        'media' => 'file'
    ),
    ...
    // Image Overlay Color
    array('name' => __('Image Overlay Color','tfuse'),
        'desc' => __('Enter Image Overlay Color','tfuse'),
        'id' => TF_THEME_PREFIX . '_wrapper_color',
        'value' => '',
        'type' => 'colorpicker',
    ),
    // Repeat Image
    ...
    array('name' => __('Background-color','tfuse'),
        'desc' => __('Enter background-color ex: #ccc. Leave blank for default value.','tfuse'),
