...
<?php get_sidebar(); ?>
		...
		<footer class="site-footer" role="contentinfo" itemscope="itemscope" itemtype="http://schema.org/WPFooter">
			...
			<div class="wrap">
				...
				<div class="site-info">
					&copy;  <?php echo date('Y'); ?> <?php bloginfo('name'); ?>. <a href="<?php echo esc_url('http://cotterthecreative.com/'); ?>" title="<?php esc_attr_e( 'Cotter The Creative', 'themebeagle' ); ?>"><?php printf( __( 'Website by %s', 'themebeagle' ), 'Cotter The Creative' ); ?></a>
				</div><!-- .site-info -->
<p>
<center><span style="line-height: 1.6;"><a href="http://www.marcpariser.com">Home</a> / <a href="http://www.marcpariser.com/about">About</a> / <a href="http://www.marcpariser.com/services">Services</a> / <a href="http://www.marcpariser.com/contact/">Contact</a></span>
